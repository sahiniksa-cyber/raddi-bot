...
const RE = {
  // NOTE: كلم/كلّم must be the imperative "call/contact", not a fragment of تكلم/
  // نتكلم ("speak") — a style instruction like "تكلم سعودي" is NOT an escalation.
  escVerb: /(?:حوّل|حول|صعّد|صعد|بلّغ|بلغ|(?<![تن])كلّم|(?<![تن])كلم|رجّع|راجع|حوّله|حوله|صعده|اتصل|تواصل)/,
