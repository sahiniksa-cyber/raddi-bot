...
// monotonic counter. The owner/fromMe path passes false so it never advances the
// sequence (it isn't a customer turn the stale guard should react to). The bump
// amount is parameterised so the same INSERT ... ON CONFLICT works for both.
