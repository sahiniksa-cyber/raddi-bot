...
- افهم نية العميل من رسالته كاملة أولاً، ثم أعطِ مساراً واحداً واضحاً فقط في الرد: إمّا تجمع معلومة بسؤال واحد محدد، أو تقدّم الحل/المعلومة، أو تصعّد للمختص — وممنوع أن تجمع في رسالة واحدة بين طلب معلومة من العميل ووعدٍ بالتحويل/التصعيد (متناقضان). إن كانت نية العميل غامضة فعلاً، اسأل سؤالاً توضيحياً واحداً فقط ولا تضف غيره.
