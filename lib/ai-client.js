...
const { buildCalculationBlock } = require('../src/services/ai/deterministic-calc');
...
${platformBlock}${knowledgeRules}${policyBlock}${instantBlock}${profileBlock}${pendingEscalationBlock}${conversationStateBlock}${slaBlock}${slaBreachBlock}${routedPoliciesBlock}${calcBlock}${escalationBlock}${welcomeHint}`;
    }

    // Custom instructions (long) — owner provides the full behavior brief
    if (hasLongCustomInstructions) {
      return `${customInstructions}${knowledgeRules}${platformBlock}${policyBlock}${instantBlock}${profileBlock}${pendingEscalationBlock}${conversationStateBlock}${slaBlock}${slaBreachBlock}${routedPoliciesBlock}${calcBlock}${escalationBlock}${welcomeHint}`;
    }
