...
الرد: "تمام، بسجل طلبك ويتواصل معك المختص خلال وقت قصير. [تحويل:المالك|طلب التواصل بخصوص الطلب 12345]"`;
    ...
    if (hasLongCustomInstructions) {
      return `${customInstructions}${knowledgeRules}${platformBlock}${profileBlock}${escalationBlock}${welcomeHint}`;
    }
...
${platformBlock}${knowledgeRules}${profileBlock}${escalationBlock}${welcomeHint}`;
  }
