...
const { buildCalculationBlock, resolvePriceComputation, buildPriceComputationBlock } = require('../src/services/ai/deterministic-calc');
...
- لا تُصدر علامة تحويل [تحويل:...] جديدة لنفس الموضوع. لا تستخدمها إلا إذا طلب العميل صراحةً التحدث مع مسؤول الآن، أو أبلغ عن مشكلة جديدة مختلفة تماماً.`
    ...
    const priceComputationBlock = buildPriceComputationBlock(
      resolvePriceComputation({ history, latestUserText: lastUserText, config: this.config }),
    );
