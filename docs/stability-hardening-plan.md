...
| 10 الأمان/العزل | ✅ (شريحة آمنة + بنود مؤجَّلة بمبرّر) | `a512651` | نطاقات SSRF محجوزة إضافية + 4 اختبارات + السويت 1509/1509 |

## بنود المرحلة 10 المؤجَّلة (بمبرّر تقني — مسموح بشروط القبول)
هذي البنود **تغيّر سلوك المصادقة/الجلب/العزل الحيّ** ولا يمكن التحقق منها بأمان بلا بيئة staging/حيّة (ممنوعة هنا)؛ نشرها أعمى يخالف شرط "بدون مشاكل". تُنفَّذ لاحقاً على بيئة اختبار مجهّزة:
